    ...
    <body>
        ...
        <div class="login">
            ...
            <form action="" method="post" class="form-abu border">
                ...
                <input type="text" name="username" placeholder="Username : admin | operator" class="full">
                <label for="">Password</label>
                <input type="password" name="password" placeholder="Password : admin | operator" class="full">
                <label for=""></label>
